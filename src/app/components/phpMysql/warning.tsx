  ...
  render(): JSX.Element {
    return (
      <MessageBar messageBarType={MessageBarType.warning} isMultiline>
        ...
        <Link
          href='https://github.com/rizz-wan/mocktail-msal/blob/master/src/api/connect.php'
          target='_blank'
        ...
        {' file and import'}
        <Link
          href='https://github.com/rizz-wan/mocktail-msal/blob/master/src/api/colors.sql'
          target='_blank'
          rel='noreferrer noopener'
        >
